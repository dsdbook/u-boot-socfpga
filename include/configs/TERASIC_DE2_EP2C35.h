...
/* modify by dxzhang <dxzhang@ustc.edu>, for Terasic DE2 EP2C35 Board */
 ...
 * BOARD/CPU
 *----------------------------------------------------------------------*/
#include "../../board/altera/terasic_de2_ep2c35/custom_fpga.h" /* fpga parameters */
#define CONFIG_BOARD_NAME "Terasic DE2 EP2C35 board" /* custom board name */

#define CONFIG_TERASIC_DE2_EP2C35	1	/* terasic DE2 ep2c35 board*/
...
/*------------------------------------------------------------------------
 * FLASH  (S29AL032D, Terasic DE2 EP2C35 board)
 *----------------------------------------------------------------------*/

/* dxzhang : need to read flash  datasheet */
#define CONFIG_SYS_MAX_FLASH_SECT	71		/* Max # sects per bank */
#define CONFIG_SYS_MAX_FLASH_BANKS	1		/* Max # of flash banks */
#define CONFIG_SYS_FLASH_ERASE_TOUT	8192*16		/* Erase timeout (msec) */
#define CONFIG_SYS_FLASH_WRITE_TOUT	16*32		/* Write timeout (msec) */
